...
CREATE DATABASE a23anxobo_empleados;
GO

-- Usar la base de datos recién creada
USE a23anxobo_empleados;
GO

-- Crear la tabla TCENTR
CREATE TABLE TCENTR (
    numce SMALLINT NOT NULL,
    nomce VARCHAR(30) NOT NULL,
    señas VARCHAR(60) NOT NULL,
    CONSTRAINT PK_numce PRIMARY KEY (numce)
);

-- Crear la tabla TDEPTO
CREATE TABLE TDEPTO (
    ...
    CONSTRAINT PK_numde PRIMARY KEY (numde),
);

-- Crear la tabla TEMPLE
CREATE TABLE TEMPLE (
    numen INT NOT NULL,
    numde SMALLINT,
    extel INT NOT NULL,
    ...
    CONSTRAINT PK_numem PRIMARY KEY (numen),
);


ALTER TABLE TEMPLE
ADD CONSTRAINT FK_numde FOREIGN KEY (numde) REFERENCES TDEPTO(numde);

-- Añadir constraint FK_direc a TDEPTO (ya que TEMPLE ahora existe)
ALTER TABLE TDEPTO
ADD CONSTRAINT FK_direc FOREIGN KEY (direc) REFERENCES TEMPLE(numen),
    CONSTRAINT FK_numce FOREIGN KEY (numce) REFERENCES TCENTR(numce);

-- Insertar datos en TCENTR
